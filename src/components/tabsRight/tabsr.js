...
export default class AtTabsR extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const tabItems = tabList.map((item, idx) => {
            ...
            return (React.createElement(View, { className: itemCls, id: `tab${this._tabId}${idx}`, key: item.title, onClick: this.handleClick.bind(this, idx) },
                item.title,
