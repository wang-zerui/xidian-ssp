...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return import(/* webpackChunkName: "stencil-polyfills-css-shim" */ './css-shim.stencil-client.mjs').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return import(/* webpackChunkName: "stencil-polyfills-dom" */ './dom.stencil-client.mjs').then(() => opts);
        }
    }
