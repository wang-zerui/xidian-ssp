...
const createElm = (e, t, a, o) => {
 ...
 if (appData.BUILD.isDev && (e.$flags$ |= 1024), (appData.BUILD.hasRenderFn || appData.BUILD.reflect) && (appData.BUILD.vdomRender || appData.BUILD.reflect ? appData.BUILD.hydrateServerSide ? renderVdom(e, await callRender(e, t)) : renderVdom(e, callRender(e, t)) : o.textContent = callRender(e, t)), 
