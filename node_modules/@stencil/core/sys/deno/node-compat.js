...
function readFile(e, t, n) {
 ...
 const i = getEncoding(t), o = Deno.readFile(e);
 r && o.then((e => {
  if (i && "binary" !== i) {
...
function writeFile(e, t, n, r) {
 ...
 const s = isFileOptions(o) ? o.flag : void 0, a = isFileOptions(o) ? o.mode : void 0, l = checkEncoding$1(getEncoding(o)) || "utf8", c = getOpenOptions(s || "w");
...
function parse$3(e, t = "&", n = "=", {decodeURIComponent: r = unescape, maxKeys: i = 1e3} = {}) {
...
function tryPackage(e, t, n, r) {
 ...
 if (!i) return tryExtensions(resolve$2(e, "index"), t);
 const s = resolve$2(e, i);
...
class Buffer extends Uint8Array {
 static alloc(e, t, n = "utf8") {
  ...
  if (0 === e) return r;
  let i;
  if ("string" == typeof t) n = checkEncoding(n), "string" == typeof t && 1 === t.length && "utf8" === n ? r.fill(t.charCodeAt(0)) : i = Buffer.from(t, n); else if ("number" == typeof t) r.fill(t); else if (t instanceof Uint8Array) {
 ...
 static from(e, t, n) {
  ...
  return "string" == typeof e ? (i = checkEncoding(i, !1), new Buffer("hex" === i ? function o(e) {
   return function t(e) {
...
const captureRejectionSymbol = Symbol.for("nodejs.rejection"), nodeEvents = {
 ...
 globToRegExp: function globToRegExp(e, {extended: t = !1, globstar: n = !0} = {}) {
  const r = function i(e, {extended: t = !1, globstar: n = !1, strict: r = !1, filepath: o = !1, flags: s = ""} = {}) {
   function a(e, t = {
    ...
    "path" !== i && (c += e), o && "regex" !== i && (f += e.match(l) ? SEP$1 : e, n ? (r && (u += e), 
    "" !== u && (s.includes("g") || (u = `^${u}$`), h.push(new RegExp(u, s))), u = "") : u += e);
   }
   const l = new RegExp(`^${SEP$1}${r ? "" : "+"}$`);
   let c = "", u = "", f = "";
   const h = [];
   let d = !1, p = !1;
   const g = [];
   let m, y;
   for (let i = 0; i < e.length; i++) if (m = e[i], y = e[i + 1], [ "\\", "$", "^", ".", "=" ].includes(m)) a("\\" + m); else if (m.match(l)) a(SEP$1, {
    split: !0
 ...
 writeFileSync: function writeFileSync(e, t, n) {
  e = e instanceof URL ? fromFileUrl$2(e) : e;
  const r = isFileOptions(n) ? n.flag : void 0, i = isFileOptions(n) ? n.mode : void 0, o = checkEncoding$1(getEncoding(n)) || "utf8", s = getOpenOptions(r || "w");
...
class Module {
 ...
 _compile(e, t) {
  const n = function r(e, t) {
   ...
   if (i) throw i;
   return r;
  }(t, e), i = dirname$2(t), o = makeRequireFunction(this), s = this.exports, a = s;
 ...
 static _resolveFilename(e, t, n, r) {
  ...
  let o;
  if ("object" == typeof r && null !== r) if (Array.isArray(r.paths)) if (e.startsWith("./") || e.startsWith("../") || isWindows$2 && e.startsWith(".\\") || e.startsWith("..\\")) o = r.paths; else {
 ...
 static _nodeModulePaths(e) {
  if (isWindows$2) {
   ...
   for (let n = e.length - 1, r = 0, i = e.length; n >= 0; --n) {
    ...
    o === CHAR_BACKWARD_SLASH$1 || o === CHAR_FORWARD_SLASH$1 || o === CHAR_COLON$1 ? (r !== nmLen && t.push(e.slice(0, i) + "\\node_modules"), 
  ...
  }
  {
   ...
   for (let n = e.length - 1, r = 0, i = e.length; n >= 0; --n) {
    const o = e.charCodeAt(n);
    o === CHAR_FORWARD_SLASH$1 ? (r !== nmLen && t.push(e.slice(0, i) + "/node_modules"), 
    i = n, r = 0) : -1 !== r && (nmChars[r] === o ? ++r : r = -1);
   }
