...
const Video = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: index$1.classNames('taro-video-container', {
            ...
            }, controls: controls, currentTime: this.currentTime, duration: this.duration || this._duration || undefined, isPlaying: this.isPlaying, pauseFunc: this.pause, playFunc: this.play, seekFunc: this.seek, showPlayBtn: this.showPlayBtn, showProgress: this.showProgress }, showMuteBtn && (core.h("div", { class: index$1.classNames('taro-video-mute', {
